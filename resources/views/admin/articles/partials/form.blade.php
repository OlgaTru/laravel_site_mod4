...
@endif
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('category_id', $categories_list, $article->category_id, array('placeholder' => 'Категория','class' => 'form-control', 'id'=>'sel1' )) !!}
                </div>

                <div class="form-group">
                    <strong>Содержит категорию "Аналитика":</strong>
                    <label for="radio1">Да</label>
                    {!! Form::radio('analytics', 1, $article->analytics, ['id' => 'radio1']) !!}
                    <label for="radio2">Нет</label>
                    {!! Form::radio('analytics', 0, !$article->analytics, ['id' => 'radio2']) !!}
                ...
                <div class="form-group">
                    <strong>Теги:</strong>
                    {!! Form::text('keywords',$keywords, array('placeholder' => 'Теги','class' => 'form-control')) !!}
                </div>
